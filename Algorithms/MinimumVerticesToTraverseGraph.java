...
/* 
 * Ask if need to handle cycles, if not (less likely), then just inbound ==0 check to find all start vertices
 * if yes, then we need to the following complex way or just assume cycles
 */
public class MinimumVerticesToTraverseGraph {

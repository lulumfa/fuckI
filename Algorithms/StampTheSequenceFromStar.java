// Time Complexity: O(N(N-M))O(N(N−M)), where M, NM,N are the lengths of stamp, target.

// Space Complexity: O(N(N-M))O(N(N−M))

// reverse thought, stamp things back to start from target string
